...
public class LineKindControllerTest extends TestCase implements LineKind{
	...
	public void testEND_WITH_CONT(){
		assertEquals(END_WITH_CONTINUE_LINE,lineKindController.whitch("fi;   \\"));
		assertTrue(END_WITH_CONTINUE_LINE!=lineKindController.whitch("fi;   \"\\\""));
	}
	...
	public void testContinue(){
		assertEquals(RUN_WITH_CONTINUE_LINE,lineKindController.whitch("aaa \\"));
		assertEquals(RUN_WITH_CONTINUE_LINE,lineKindController.whitch("case \\"));
	}
	...
	public void testHere(){
		assertEquals(HERE_DOC_START_LINE,lineKindController.whitch("aaa << EOD"));
		...
		assertEquals(HERE_DOC_START_LINE,lineKindController.whitch("aaa <<- EOD2  #888\\"));
		assertEquals("EOD2",lineKindController.getHereDocMark());
		assertEquals(HERE_DOC_IN_LINE,lineKindController.whitch("aaa <<- EOD2  #888\\"));
		assertEquals(HERE_DOC_IN_LINE,lineKindController.whitch("EOD2 <<- EOD2  #888\\"));
